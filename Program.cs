    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            names.AddRange(new string[] {"Попов Иван Богданович", "Нечаев Владимир Гордеевич", "Галкин Даниил Дамирович",
                "Павлов Максим Львович", "Акимов Максим Вадимович", "Новиков Илья Александрович", "Мартынов Дмитрий Вадимович"});
            posts.AddRange(new string[] { "Генеральный директор", "Исполнительный директор", "Финансовый директор", 
                 "Заведующий складом", "Мастер участка", "Менеджер по рекламе", "Начальник гаража" });
